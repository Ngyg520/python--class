...
#当被导入模块中存在__all___=[]，则---使用from 模块名 import * 这种方式进行导入的时候，只能导入__all__=[]里面定义的变量或者函数。
# from  my_module import *
# say_hello()
# print(name)
# say_haha()
...
#导入包
#导入包的本质:执行包里面的__init__.py文件里面的代码
# import package_test
...
# from package_test import my_module2#调用包里面的.py
# print(my_module2.sex)
# my_module2.say_heihei()#调用包里面的函数
